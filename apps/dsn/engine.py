...
from apps.dsn.utils.subapp_loader import SubAppConfig
from apps.dsn.config import Config
from apps.dsn.maintenance.hibernate import HibernateManager
...
class DSNEngine:
    ...
    def _init_from_subapp(self):
        ...
        from apps.dsn.utils.subapp_loader import load_subapp_config
    ...
    def _init_database(self):
        ...
        from apps.dsn.async_task_store import AsyncTaskStore
...
"""
    ...
    def _retry_engine_action(self, ai_message: str, task, retry_depth: int):
        ...
        from apps.dsn.plugins.builtin.task_plugin import TaskPlugin
        from apps.dsn.tasks import TaskType
    ...
    def _init_world(self):
        ...
        if not Config.WORLD_ENABLED:
            return
        try:
            from apps.dsn.world import WorldEngine, WorldStateManager, NarrativeModel
    ...
    def _inject_system_skill_deps(self):
        ...
        try:
            # 注入 NotebookStore
            from apps.dsn.plugins.builtin.notebook.notebook_store import NotebookStore
    ...
    def _init_plugins_via_loader(self):
        ...
        if self.world_engine:
            from apps.dsn.world.action_narrator import ActionNarrator
        ...
        loader = PluginLoader(["apps/dsn/plugins/builtin", "world"])
...
def create_engine_with_defaults(
    ...
    """
    import os as _os
    from apps.dsn.prompt import init_prompt_engine, PromptLibrary, PersonalitySystemV2
