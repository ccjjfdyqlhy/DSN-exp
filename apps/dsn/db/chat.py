    ...
    def _init_db(self):
        ...
        with self._init_lock:
            ...
            try:
                ...
                # 人格系统 v2 状态表
                from apps.dsn.prompt.personality_v2.persistence import CREATE_PERSONALITY_TABLE
                conn.execute(CREATE_PERSONALITY_TABLE)

                # 人格系统 v3 持久层表
                try:
                    from apps.dsn.prompt.personality_v3.persistence import ALL_TABLES as V3_TABLES
