...
from apps.dsn.api.alarm import check_and_trigger as check_alarms
...
def _inject_vision_fields(response):
    ...
    try:
        from apps.dsn.api.vision import coordinator as _coord
    ...
    try:
        from apps.dsn.api.vision import stream_service as _stream_svc
