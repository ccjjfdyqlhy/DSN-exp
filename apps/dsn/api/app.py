...
def v3_card_upload():
    ...
    try:
        from apps.dsn.prompt.personality_v3 import CharacterCard
...
def fate_roll():
    ...
    try:
        ...
        if m:
            ...
            # 骰池表达式: 2d6+1d4+3
            from apps.dsn.world.fate import DicePool
...
def fate_table_roll():
    ...
    """
    from apps.dsn.world.fate import ProbabilityTable
    try:
        data = request.get_json() or {}
