...
class AlbumHelper(IDCahceHelper):
    def __init__(self, item_id):
        from apps.dsn.pyncm.apis.album import getAlbumInfo
...
class ArtistHelper(IDCahceHelper):
    def __init__(self, item_id):
        from apps.dsn.pyncm.apis.artist import getArtistDetails
...
class UserHelper(IDCahceHelper):
    def __init__(self, item_id):
        from apps.dsn.pyncm.apis.user import getUserDetail
