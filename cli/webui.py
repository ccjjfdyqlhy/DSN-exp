...
<body class="is-new-chat">
    ...
    <script>
        ...
        const statusMap = {
            ...
            'execution': { text: '设定任务', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>' },
