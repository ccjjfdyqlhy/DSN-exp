...
|:-----|------:|------:|------:|------:|:------:|
| 循环复杂度 | 10.59% | 0.0% | 80.0% | 4.0% | ✓✓ |
| 认知复杂度 | 14.08% | 0.0% | 70.0% | 10.0% | ✓✓ |
| 嵌套深度 | 4.40% | 0.0% | 65.0% | 0.0% | ✓✓ |
| 函数长度 | 6.37% | 0.0% | 56.8% | 0.0% | ✓✓ |
| 文件长度 | 2.89% | 0.0% | 94.0% | 0.0% | ✓✓ |
| 参数数量 | 13.52% | 0.0% | 98.5% | 0.0% | ✓✓ |
| 代码重复 | 4.82% | 0.0% | 67.6% | 0.0% | ✓✓ |
| 结构分析 | 5.12% | 0.0% | 79.5% | 0.0% | ✓✓ |
| 错误处理 | 33.91% | 0.0% | 98.8% | 11.1% | ✓ |
| 注释比例 | 42.02% | 0.0% | 100.0% | 37.8% | ○ |
| 命名规范 | 27.02% | 0.0% | 95.7% | 22.2% | ✓ |
...
> 行数: 1120 总计, 916 代码, 46 注释 | 函数: 30 | 类: 1

**问题**: 🔄 复杂度问题: 21, ⚠️ 其他问题: 7, 🏗️ 结构问题: 12, ❌ 错误处理问题: 31, 📝 注释问题: 1, 🏷️ 命名问题: 10

#### 函数详情

| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `process_stream` | L847-1119 | 273 | 57 | 7 | 3 | ✓ |
| `_poll_pending_tasks` | L713-835 | 123 | 38 | 6 | 4 | ✓ |
| `_run_agent_loop` | L341-456 | 116 | 23 | 4 | 2 | ✗ |
| `_synthesize_lines_sync` | L594-675 | 82 | 23 | 4 | 4 | ✓ |
| `process` | L179-262 | 84 | 16 | 3 | 2 | ✗ |
| `_run_tool` | L296-333 | 38 | 9 | 4 | 0 | ✓ |
| `_print_timing` | L458-483 | 26 | 9 | 4 | 3 | ✗ |
| `_format_tag_results` | L494-511 | 18 | 8 | 3 | 1 | ✗ |
| `_run_all_plugins` | L686-711 | 26 | 8 | 2 | 5 | ✗ |
| `_dispatch_pre_process` | L535-572 | 38 | 7 | 1 | 2 | ✓ |
...
| `_print_plugin_timing` | L485-491 | 7 | 4 | 2 | 2 | ✗ |
| `_assemble_prompt` | L513-531 | 19 | 4 | 1 | 2 | ✓ |
| `_invoke` | L61-69 | 9 | 3 | 2 | 0 | ✗ |
| `_bridge_progress` | L678-684 | 7 | 3 | 2 | 2 | ✗ |
...
| `_synthesize_lines` | L576-582 | 7 | 1 | 0 | 2 | ✓ |
| `_synthesize_lines_stream` | L584-592 | 9 | 1 | 0 | 3 | ✓ |

**全部问题 (80)**

- 🔄 `process()` L179: 复杂度: 16
- 🔄 `_run_agent_loop()` L341: 复杂度: 23
- 🔄 `_synthesize_lines_sync()` L594: 复杂度: 23
- 🔄 `_poll_pending_tasks()` L713: 复杂度: 38
- 🔄 `process_stream()` L847: 复杂度: 57
- 🔄 `process_tts()` L144: 认知复杂度: 14
- 🔄 `process()` L179: 认知复杂度: 22
- 🔄 `_run_tool()` L296: 认知复杂度: 17
- 🔄 `_run_agent_loop()` L341: 认知复杂度: 31
- 🔄 `_print_timing()` L458: 认知复杂度: 17
- 🔄 `_format_tag_results()` L494: 认知复杂度: 14
- 🔄 `_synthesize_lines_sync()` L594: 认知复杂度: 31
- 🔄 `_poll_pending_tasks()` L713: 认知复杂度: 50
- 🔄 `process_stream()` L847: 认知复杂度: 71
- 🔄 `process_tts()` L144: 嵌套深度: 4
- 🔄 `_run_tool()` L296: 嵌套深度: 4
- 🔄 `_run_agent_loop()` L341: 嵌套深度: 4
- 🔄 `_print_timing()` L458: 嵌套深度: 4
- 🔄 `_synthesize_lines_sync()` L594: 嵌套深度: 4
- 🔄 `_poll_pending_tasks()` L713: 嵌套深度: 6
- 🔄 `process_stream()` L847: 嵌套深度: 7
- 📏 `process()` L179: 84 代码量
- 📏 `_run_agent_loop()` L341: 116 代码量
- 📏 `_synthesize_lines_sync()` L594: 82 代码量
- 📏 `_poll_pending_tasks()` L713: 123 代码量
- 📏 `process_stream()` L847: 273 代码量
...
- 🏗️ `_run_agent_loop()` L341: 中等嵌套: 4
- 🏗️ `_print_timing()` L458: 中等嵌套: 4
- 🏗️ `_format_tag_results()` L494: 中等嵌套: 3
- 🏗️ `_synthesize_lines_sync()` L594: 中等嵌套: 4
- 🏗️ `_poll_pending_tasks()` L713: 嵌套过深: 6
- 🏗️ `process_stream()` L847: 嵌套过深: 7
- 🏗️ L1: 文件过大: 1120 行
- 🏗️ L1: 导入过多: 29
- ❌ L151: 未处理的易出错调用
- ❌ L173: 未处理的易出错调用
...
- 🏷️ `_run_agent_loop()` L341: "_run_agent_loop" - snake_case

**详情**:
- 循环复杂度: 平均: 8.4, 最大: 57
- 认知复杂度: 平均: 12.4, 最大: 71
- 嵌套深度: 平均: 2.0, 最大: 7
- 函数长度: 平均: 34.2 行, 最大: 273 行
- 文件长度: 916 代码量 (1120 总计)
- 参数数量: 平均: 2.0, 最大: 8
- 代码重复: 3.3% 重复 (1/30)
- 结构分析: 12 个结构问题
- 错误处理: 31/70 个错误被忽略 (44.3%)
- 注释比例: 5.0% (46/916)
- 命名规范: 发现 21 个违规
...
> 行数: 1025 总计, 848 代码, 21 注释 | 函数: 51 | 类: 5
...
> 行数: 730 总计, 606 代码, 40 注释 | 函数: 13 | 类: 0
...
| 函数 | 行范围 | 行数 | 复杂度 | 嵌套 | 参数 | 注释 |
|:-----|------:|------:|------:|------:|------:|:------:|
| `create_application` | L352-729 | 378 | 42 | 4 | 0 | ✓ |
| `_preload_models` | L255-326 | 72 | 13 | 2 | 1 | ✓ |
| `_synthesize_tts_lines` | L129-151 | 23 | 10 | 2 | 1 | ✗ |
| `process_task_completion` | L178-196 | 19 | 8 | 3 | 0 | ✗ |
| `_handle_action_completion` | L225-250 | 26 | 8 | 2 | 3 | ✗ |
| `_convert_audio_to_wav` | L110-126 | 17 | 5 | 2 | 1 | ✗ |
| `_process_image_input` | L82-97 | 16 | 4 | 1 | 2 | ✗ |
| `create_chat_client` | L68-79 | 12 | 3 | 1 | 1 | ✗ |
| `_handle_reasoner_completion` | L215-222 | 8 | 3 | 1 | 2 | ✗ |
| `_save_debug_audio` | L100-107 | 8 | 2 | 1 | 1 | ✗ |
| `setup_logging` | L154-175 | 22 | 2 | 1 | 1 | ✗ |
| `_handle_reminder_completion` | L199-212 | 14 | 2 | 1 | 2 | ✓ |
| `_t` | L336-347 | 12 | 2 | 1 | 1 | ✗ |

**全部问题 (29)**

- 🔄 `_preload_models()` L255: 复杂度: 13
- 🔄 `create_application()` L352: 复杂度: 42
- 🔄 `_synthesize_tts_lines()` L129: 认知复杂度: 14
- 🔄 `process_task_completion()` L178: 认知复杂度: 14
- 🔄 `_preload_models()` L255: 认知复杂度: 17
- 🔄 `create_application()` L352: 认知复杂度: 50
- 🔄 `create_application()` L352: 嵌套深度: 4
- 📏 `_preload_models()` L255: 72 代码量
- 📏 `create_application()` L352: 378 代码量
- 📋 `_save_debug_audio()` L100: 重复模式: _save_debug_audio, _handle_reminder_completion
- 🏗️ `process_task_completion()` L178: 中等嵌套: 3
- 🏗️ `create_application()` L352: 中等嵌套: 4
- 🏗️ L1: 导入过多: 57
- ❌ L105: 未处理的易出错调用
- ❌ L106: 未处理的易出错调用
- ❌ L147: 未处理的易出错调用
...
- ❌ L464: 未处理的易出错调用
- ❌ L707: 未处理的易出错调用
- 🏷️ `_process_image_input()` L82: "_process_image_input" - snake_case
- 🏷️ `_save_debug_audio()` L100: "_save_debug_audio" - snake_case
- 🏷️ `_convert_audio_to_wav()` L110: "_convert_audio_to_wav" - snake_case
- 🏷️ `_synthesize_tts_lines()` L129: "_synthesize_tts_lines" - snake_case
- 🏷️ `_handle_reminder_completion()` L199: "_handle_reminder_completion" - snake_case
- 🏷️ `_handle_reasoner_completion()` L215: "_handle_reasoner_completion" - snake_case
- 🏷️ `_handle_action_completion()` L225: "_handle_action_completion" - snake_case
- 🏷️ `_preload_models()` L255: "_preload_models" - snake_case
- 🏷️ `_t()` L336: "_t" - snake_case

**详情**:
- 循环复杂度: 平均: 8.0, 最大: 42
- 认知复杂度: 平均: 11.4, 最大: 50
- 嵌套深度: 平均: 1.7, 最大: 4
- 函数长度: 平均: 48.2 行, 最大: 378 行
- 文件长度: 606 代码量 (730 总计)
- 参数数量: 平均: 1.2, 最大: 3
- 代码重复: 7.7% 重复 (1/13)
- 结构分析: 3 个结构问题
